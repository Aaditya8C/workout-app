  ...
  return (
    <ScrollView className="flex-1 flex flex-col gap-2 bg-white">
      <View className="pt-2 flex flex-row justify-center">
        ...
        />
        <Text className="text-2xl text-violet-600 font-bold">Kasarat</Text>
      </View>
      ...
      <View>
        <Text className="pl-4 tracking-widest text-gray-400">MY TEMPLATES</Text>
      </View>
      <View className="border self-center w-[95%] border-gray-300 p-2 rounded-md">
        <View className="flex flex-row justify-between">
          <Text className="text-lg font-semibold">Shoulders - Variation 1</Text>
          <Image
        ...
        <View className="">
          ...
          <Text className="text-gray-500 ">{"2x Lateral Raise (Cardio)"}</Text>
        </View>
      </View>
    </ScrollView>
  );
