  ...
  return (
    <SafeAreaView className="flex-1 bg-white flex space-y-3" edges={["top"]}>
      <View className="pt-2 flex flex-row  justify-center gap-2 items-center">
        <Text className="tracking-wider text-neutral-700 text-lg">
          READY TO
        </Text>
        <View
          className="flex flex-row items-center rounded-lg bg-white p-1"
          style={{ elevation: 5 }}>
          <Image
            className="w-10 h-10"
            source={require("../../assets/images/stretchlogo.png")}></Image>
          <Text className="font-bold tracking-wider text-violet-500 text-2xl">
            STRETCH
          </Text>
        </View>
      </View>
      ...
      <View className="flex flex-row flex-wrap justify-center  px-5 gap-6">
        <Pressable
          className="w-[40%] bg-white rounded-xl flex items-center p-3"
          style={{ elevation: 5 }}
          onPress={() => {
        ...
        <Pressable
          ...
          <Image
            className="w-20 h-20"
            source={require("../../assets/images/ai.png")}></Image>
          <Text className="text-sm font-bold p-1">Chat with AI</Text>
        </Pressable>
        <Pressable
          className="w-[40%] bg-violet-100 rounded-xl flex items-center p-3"
          style={{ elevation: 5 }}
          onPress={() => {
          ...
          <Image
            className="w-20 h-20"
            source={require("../../assets/images/training.png")}></Image>
        ...
        <Pressable
          ...
          <Image
            className="w-20 h-20"
            source={require("../../assets/images/bookshelf.png")}></Image>
